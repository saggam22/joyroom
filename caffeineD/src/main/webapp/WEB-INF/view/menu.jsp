				...
				<c:choose>
					...
					<c:otherwise>
						<li class="nav-item px-lg-4">
							...
							<c:choose>
								<c:when test="${user.nickname == '관리자'}"> <a class="nav-link text-uppercase" href="${pageContext.servletContext.contextPath }/view/admin/adminPage.tiles" style="display: inline-block;">${user.nickname }</a></c:when>
