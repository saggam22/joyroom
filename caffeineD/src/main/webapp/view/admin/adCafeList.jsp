...
<body>
	...
	<div id="container">
		...
		<button type="button" onclick="location.href='${pageContext.servletContext.contextPath }/adCafeInsertView.do'">등록</button>
		...
		<table border="1">
			...
			<tbody>
				<c:forEach items="${adCafeList }" var="ad_cafe">
					<tr>
						<td><input type="radio" name="cafe_no" value="${ad_cafe.no }"></td>
						<td>${ad_cafe.no }</td>
						<td>${ad_cafe.name }</td>
		...
		<button type="button" name="update_view_btn" onclick="adCafeUpdateView();">수정</button>
