...
<body>
	<div class="admin_menu">
		...
		<a class="menu_btn" id="my_board"  href="${pageContext.servletContext.contextPath }/myBoard.do">내 글</a> 
		<a class="menu_btn" id="my_comment" href="${pageContext.servletContext.contextPath }/myComment.do">내 댓글</a>
		<a class="menu_btn" id="my_review" href="${pageContext.servletContext.contextPath }/myReview.do">내 리뷰</a>
