...
<body>
	...
	<div id="container">
			...
			<c:otherwise>
				<article>
					...
					<c:forEach var="review" items="${myReviewList }">
						<div class="review">
							<p>${review.cafeName }</p>
							<img src="img/cafeimg/${review.cafeImg }" style="width: 40px"></img>
							<button type="button"
						...
						<div class="review_section">
							<div id="${review.no }" class="review">
								...
								<div class="review_right">
									...
									<div class="star" style="position: relative;">
										...
										<span
											style="position: absolute; right: 1%; top: 5px; margin-left: 5px;">
							...
							<div class="btn_section">
								<a href="#reviewUpdate" class="btn_open"><button
										...
										class="delBtn" name="delBtn_${review.no }" type="button"
										style="cursor: pointer;">삭제</button></a>
							</div>
						</div>
					</c:forEach>
				</article>
				<button id="moreBtn" onClick="listMore()">
					<img
				...
				<div class="pop_inner">
					...
					<form
						...
						<div class="pop_left">
							...
							<label for="uploadImg"
								style="border: none; font-size: 10pt; margin: 20px 0 0 120px; color: rgb(120, 120, 120);">사진
						...
						<div class="pop_right">
							...
							<div style="text-align: center;">
								<button id="innerBtn" type="submit">Upload</button>
							</div>
						</div>
		...
		<div id="topBtn" style="cursor: pointer;"
